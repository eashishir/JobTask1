...
const Footer = () => {
    return (
        <div>
            <footer className="footer p-10 bg-info-content text-base-content">
                <div className='px-12'>
                    <h1 className='text-3xl font-extrabold text-orange-700'>CRYPTO <span className='text-white
                    '>GURU DEALS</span></h1>
                    <p className='text-white'>© 2023 Crypto Guru Deals. All rights reserved</p>
                    ...
                    <div className="grid grid-flow-col gap-4 text-white">
                        ...
                        <a className='text-3xl' href="#"> <AiFillLinkedin/> </a>
                        <a className='text-3xl' href="#"> <AiFillInstagram/> </a>
